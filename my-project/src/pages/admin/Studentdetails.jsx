...
function Studentdetails({visible, setVisible, handleClose, selectedstudent}) {
  ...
  return (
    <>
      ...
      <div className="w-full mx-auto absolute z-50 pt-2 top-10 left-0 flex items-start ">
          ...
          >
            <div className="w-full px-4 flex flex-col">
              <div className="w-full h-[90vh]">
                <h2 className="font-bold text-2xl">{selectedstudent?.name}</h2>
